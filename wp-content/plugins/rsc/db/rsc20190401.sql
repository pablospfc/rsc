...
CREATE TABLE `rsc_etapa_cadastro_cliente` (
  ...
  CONSTRAINT `fk_cliente` FOREIGN KEY (`id_cliente`) REFERENCES `rsc_cliente` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_etapa_cadastro` FOREIGN KEY (`id_etapa_cadastro`) REFERENCES `rsc_etapa_cadastro` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `rsc_usuario` VALUES (3,'91425057047','ca0f72e54db126bc394f444e77131fee','2019-03-29 13:20:16','2019-03-29 13:20:16');
...
-- Dump completed on 2019-04-01  9:24:06
