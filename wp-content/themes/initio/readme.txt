Theme Name: Initio
Theme URI: http://www.vmthemes.com/initio/
Author: VM Themes	
...
Initio is distributed under the terms of the GNU General Public License v2 or later
...
* Files responsive.css and editor-style.css are the theme's designer personal creations and are free for personal and commercial use.
* Scripts: animation.js, custom.js, fromblog.js, scrollup.js, gallery-slides.js, slides.js, slides-captions.js, ideal-slides.js and sticky.js are the theme's designer personal creations and are free for personal and commercial use.
...
* All Fonts used in the theme are from the Google Font API and are GPL-compatible licensed. http://www.google.com/fonts#AboutPlace:about
	...
	Raleway font (available through Google web Fonts: https://www.google.com/fonts/specimen/Raleway), licensed under SIL Open Font License, 1.1
...
* Image used in "slide1.jpg" is CC0-licensed (GPL-compatible) images from http://pixabay.com/ pixabay ID: 1150663 https://pixabay.com/en/laptop-tablet-desk-top-digital-1150663/
...
* File "ipad-1065284_1280.png" located in the 'images' folder is CC0-licensed (GPL-compatible) image, pixabay ID: 1065284. (Source: https://pixabay.com/en/ipad-tablet-flat-transparent-1065284/)

* Theme screenshot image
	CC0-licensed (GPL-compatible) images from http://pixabay.com/
	
	pixabay ID: 1150663 https://pixabay.com/en/laptop-tablet-desk-top-digital-1150663/
